...
export const onCallScheduleData: OnCallSchedule = {
  2025: { // Year
    ...
    7: { // August (0-indexed)
      ...
      7: ["ROMINA LOPEZ", "LUCIANO RAMOS", "ISMAEL VALDES"],
      ...
      21: ["LUCIANO RAMOS", "ROMINA LOPEZ", "ISMAEL VALDES"],
      ...
      28: ["ISMAEL VALDES", "LUCIANO RAMOS", "ROMINA LOPEZ"],
    ...
    8: { // September (0-indexed)
      ...
      11: ["ROMINA LOPEZ", "LUCIANO RAMOS", "ISMAEL VALDES"],
      ...
      25: ["LUCIANO RAMOS", "ISMAEL VALDES", "ROMINA LOPEZ"],
