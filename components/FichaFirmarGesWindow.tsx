...
import FichaFirmarGes from './FichaFirmarGes';
...
interface FichaFirmarGesWindowProps {
  isOpen: boolean;
  onClose: () => void;
  loggedInUser: User | null;
}

export const FichaFirmarGesWindow: React.FC<FichaFirmarGesWindowProps> = ({
  isOpen,
  onClose,
  loggedInUser,
}) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 bg-slate-50 overflow-y-auto custom-scrollbar p-3">
        {loggedInUser && (
          <FichaFirmarGes loggedInUser={loggedInUser} onClose={onClose} />
        )}
      </div>
