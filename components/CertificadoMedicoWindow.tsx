...
interface CertificadoMedicoWindowProps {
  isOpen: boolean;
  onClose: () => void;
  loggedInUser: User | null;
}

export const CertificadoMedicoWindow: React.FC<CertificadoMedicoWindowProps> = ({
  isOpen,
  onClose,
  loggedInUser,
}) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 bg-slate-50 overflow-y-auto custom-scrollbar p-3">
        <CertificadoMedicoForm onBackToMenu={onClose} loggedInUser={loggedInUser} />
      </div>
