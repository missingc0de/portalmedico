        ...
        <div className="mt-8 lg:mt-0 lg:w-2/5 xl:w-5/12 lg:sticky lg:top-20 flex flex-col lg:h-[calc(100vh-120px)]">
          ...
          <div className="flex-grow w-full space-y-4 overflow-y-auto custom-scrollbar pr-2">
            <div>
                ...
                <textarea value={anamnesisText} readOnly className="w-full p-2 bg-white border rounded-md text-xs h-32 custom-scrollbar text-slate-800" />
            </div>
            <div>
                ...
                <textarea value={exploracionText} readOnly className="w-full p-2 bg-white border rounded-md text-xs h-24 custom-scrollbar text-slate-800" />
            </div>
            <div>
                ...
                <textarea value={actuacionText} readOnly className="w-full p-2 bg-white border rounded-md text-xs h-32 custom-scrollbar text-slate-800" />
            </div>
          </div>
        </div>
      </div>
